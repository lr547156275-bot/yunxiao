import io
# Shared controller reference, written once and imported by both the unit test
# and the replay so they cannot drift apart.
body = '''# Reference implementation of the queue-bounded controller (method C:
...
'''
io.open('/work/simulation/experiment/scheme1_sba/controller_ref.py','w',
        encoding='utf-8').write(body)
print("controller_ref.py written, %d lines" % len(body.split(chr(10))))
