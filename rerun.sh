...
echo "binary sha256: $(sha256sum /work/simulation/build/scratch/third | cut -c1-16)"
echo "libns3   sha256: $(sha256sum /work/simulation/build/libns3.18-point-to-point-debug.so | cut -c1-16)"
pair() {
  for n in "$1" "$2"; do
